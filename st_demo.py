...
def main():
    ...
    def convert_flag(x):
        if x:
            return 'Use Existed Menu'
        else:
            return 'Type My Own Dish Name'
    ...
    if st.sidebar.button('Generate'):
        ...
        with st.spinner('Generating...'):
            ...
            stylized_image_ph.image(stylized_img, width=300, caption='stylized from %s' % style_name)
            ...
            oil_image_ph.image(oil_img, width=300, caption='oiled image')
            st.balloons()
